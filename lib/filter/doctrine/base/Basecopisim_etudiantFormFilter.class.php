...
/**
 * copisim_etudiant filter form base class.
 *
 * @package    copisim
 * @subpackage filter
 ...
 */
abstract class Basecopisim_etudiantFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'fac'        => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('copisim_item'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'fac'        => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('copisim_item'), 'column' => 'id')),
