...
/**
 * CopisimRegion form base class.
 *
 * @method CopisimRegion getObject() Returns the current form's model object
 *
 * @package    copisim
 * @subpackage form
 ...
 */
abstract class BaseCopisimRegionForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('copisim_region[%s]');
