 ...
 * @method CopisimFiliere      setPeriode()        Sets the current record's "periode" value
 * @method CopisimFiliere      setTitre()          Sets the current record's "titre" value
 * @method CopisimFiliere      setCopisimPeriode() Sets the current record's "CopisimPeriode" value
 * @method CopisimFiliere      setCopisimPoste()   Sets the current record's "CopisimPoste" collection
 * 
 * @package    copisim
 * @subpackage model
 ...
 */
abstract class BaseCopisimFiliere extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('copisim_filiere');
