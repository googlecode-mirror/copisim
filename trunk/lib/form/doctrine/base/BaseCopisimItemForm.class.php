...
/**
 * CopisimItem form base class.
 *
 * @method CopisimItem getObject() Returns the current form's model object
 *
 * @package    copisim
 * @subpackage form
 ...
 */
abstract class BaseCopisimItemForm extends BaseFormDoctrine
{
