...
/**
 * CopisimFac filter form base class.
 *
 * @package    copisim
 * @subpackage filter
 ...
 */
abstract class BaseCopisimFacFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('copisim_fac_filters[%s]');
